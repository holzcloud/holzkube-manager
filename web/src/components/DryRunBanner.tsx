  ...
  return (
    ...
    >
      ...
      <p className="mt-1 opacity-90">
        holzkube-managerd was started with <span className="font-mono text-xs">--dry-run</span>.
        Every mutating call is refused in the transport before it reaches a node, so applying a
