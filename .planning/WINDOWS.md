...
[
  ...
  },
  {
    ...
    "status": "resolved",
    "reason": "GESCHLOSSEN 2026-09-12: golangci-lint 2.13.2 (gebaut mit go1.26.8) wurde installiert und ueber ./... ausgefuehrt. Erster Lauf: 45 Befunde. Der wertvollste war G123 auf Code, der zehn Minuten alt war -- ein Zertifikats-Pin ueber VerifyPeerCertificate, das Go bei einer WIEDERAUFGENOMMENEN TLS-Session gar nicht aufruft; auf VerifyConnection umgestellt und mit einem Test gegen einen echten ClientSessionCache belegt. Ausserdem gefunden: zwei tote Funktionen (eine davon das Fossil des nie geschriebenen Fingerprint-Vergleichs, siehe Fenster 90), ein Doku-Kommentar, der die Cluster-CA-Warnung an die falsche Methode gehaengt hatte, und ein deprecated ImagePull (Fenster 91). Jetzt 0 Befunde. Jede verbleibende Ausnahme in .golangci.yml nennt Regel, Ort und Grund; keine Regel ist pauschal abgeschaltet.",
    "recorded_at": "2026-09-11T16:30:00.000Z",
