...
**Runde-7-Gap-Closure Wave 2** *(blocked on Wave 1; hängt an der **nicht ratifizierten** Empfehlung Variante B aus `02-DECISION-drift-guard-lexik.md` — Variante A liegt punktgleich daneben, 7,0 gegen 7,0)*
